...
![Profile Views](https://visitcount.itsvg.in/api?id=AlfaPankaj&icon=10&color=4)
...
| Component | Detail |
|---|---|
| **Core** | Real-time "User Intent Vector" (UIV) extraction (Format, Style, Complexity) |
| **Big Data** | JSON-based persistent profile store (MongoDB style) for cross-session memory |
| **Model** | Seamlessly integrated with **Local Llama 3.2:3b** via Ollama |
| **UX** | Interactive Gradio Web UI with real-time intent visualization |
| **Research** | Evaluated on 10,000+ OpenAssistant messages to quantify "Intent Alignment Tax" |
...
|---|---|---|
| [Autonomous Financial Research Agent](https://github.com/AlfaPankaj) | LangGraph · MCP · FinBERT | Multi-step reasoning workflow with neurosymbolic guardrails |
| [HinglishSearch RAG](https://github.com/AlfaPankaj) | Endee VectorDB · Docker · CHAARI 2.0 | Semantic search for Hinglish documents · sub-second retrieval |
| [Industrial Predictive Maintenance](https://github.com/AlfaPankaj) | PyTorch · LSTM · Isolation Forest | >95% recall · deployed at LG Electronics |
...
![Qwen](https://img.shields.io/badge/Qwen-purple?style=flat)
![Llama](https://img.shields.io/badge/Llama_3-0467DF?style=flat)
...
![Pankaj's GitHub Stats](https://github-readme-stats.vercel.app/api?username=AlfaPankaj&theme=merko&hide_border=true&include_all_commits=false&count_private=false)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=AlfaPankaj&theme=merko&hide_border=true&include_all_commits=false&count_private=false&layout=compact)
